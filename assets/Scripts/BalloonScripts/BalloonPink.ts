...
@ccclass('BalloonPink')
export class BalloonPink extends Component {
    ...
    onLoad() {
        ...
        if (!this.animation) {
            console.error("Animation not found into BalloonPink");
        }

        this.audioSource = this.getComponent(AudioSource);

        if (!this.audioSource) {
            console.error("AudioSource not found into BalloonPink");
        }
    }
