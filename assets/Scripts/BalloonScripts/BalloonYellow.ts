...
export class BalloonYellow extends Component {
    ...
    onLoad() {
        ...
        if (!this.animation) {
            console.error("Animation not found into BalloonYellow");
        }

        this.audioSource = this.getComponent(AudioSource);

        if (!this.audioSource) {
            console.error("AudioSource not found into BalloonYellow");
        }
    }
